...
//    Text(L10n.plants.header.count(plants.count))   // plural-aware (see .stringsdict note below)
//
//  Add more keys as views grow. Every key in here must exist in both
//  en.lproj/Localizable.strings and de.lproj/Localizable.strings.
//
